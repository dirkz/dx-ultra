...
void DXUltra::OnUpdate()
{
    ...
    double dSeconds = static_cast<double>(seconds.quot) + static_cast<double>(seconds.rem) / 1000;
}
...
{
    if (width < MinimumWindowsDimensions.x || height < MinimumWindowsDimensions.y)
    {
        return;
    }
